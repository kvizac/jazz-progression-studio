...
/**
 * Complete 8-bar harmonic sentences. Style weighting changes which grammatical families
 * are likely to appear; harmonic distance controls how far each style is allowed to wander.
 * The engine never builds a section by randomly stitching unrelated four-bar fragments.
 */
const A_FAMILIES:AFamily[]=[
  {
    ...
    classic:1.45,bebop:1.15,modern:.62,neosoul:.22,rnb:.55,
  ...
  {
    id:'a-relative-minor',family:'relative-minor route',weight:31,minColor:12,centers:['I','vi','ii','V','I','VI','ii','V'],tags:['minor','tonicization','cycle'],
    classic:1,bebop:1.08,modern:1.18,neosoul:1.05,rnb:1.22,
  ...
  {
    id:'a-major-minor-cycle',family:'major/minor cycle',weight:29,minColor:16,centers:['ii','V','I','IV','vi','V/vi','iii','VI','ii','V'],tags:['cycle','minor','tonicization'],
    classic:1.12,bebop:1.05,modern:1.18,neosoul:.85,rnb:1.12,
  ...
  {
    id:'a-subdominant-backdoor',family:'subdominant / backdoor route',weight:30,minColor:18,centers:['I','IV','iv','bVII','iii','VI','ii','V','I'],tags:['tonicization','backdoor','cycle','modal'],
    classic:1.1,bebop:.92,modern:1.30,neosoul:1.42,rnb:1.48,
    first:['IΔ9','I7','IVΔ9','iv9','iii7','VI7','ii9','V13'],
    second:['IΔ9','I7','IVΔ9','iv9,bVII13','iii7','VI7','ii9,V13','I6/9,V7'],
    final:['IΔ9','I7','IVΔ9','iv9,bVII13','iii7,VI7','ii9,V13','IΔ9','I6/9'],
  },
  {
    id:'a-modern-suspended',family:'modern suspended / Lydian route',weight:37,minColor:22,centers:['I','iii','VI','ii','V','bIII','II','ii','V'],tags:['suspended','chromatic','tonicization'],
    classic:.12,bebop:.42,modern:1.85,neosoul:.95,rnb:.55,
    first:['IΔ9♯11','iii7,VI7','ii9','V7sus','bIIIΔ9','ii7/II,V7/II','II7','ii9,V13'],
    second:['IΔ9♯11','iii7,VI7','ii9','V7sus','IVΔ9','#iv°7','I6/9,VI7','ii9,V7sus'],
    final:['IΔ9♯11','iii7,VI7','ii9','V7sus','IVΔ9','iv9,bVII13','IΔ9','I6/9'],
  },
  {
    id:'a-neosoul-pocket',family:'neo-soul borrowed-color loop',weight:44,minColor:10,centers:['vi','IV','I','V','ii','iv','bVII','I'],tags:['minor','modal','backdoor','suspended'],
    classic:.08,bebop:.08,modern:.65,neosoul:2.15,rnb:1.18,
    first:['vi9','IVΔ9','IΔ9','V7sus','ii9','iv9','bVII13','IΔ9'],
    second:['vi9','IVΔ9','IΔ9♯11','V7sus','ii9','iv9,bVII13','IΔ9','V7sus'],
    final:['vi9','IVΔ9','IΔ9♯11','V7sus','ii9','iv9,bVII13','IΔ9','I6/9'],
  },
  {
    id:'a-rnb-gospel',family:'R&B / gospel turnaround',weight:43,minColor:8,centers:['I','iii','vi','IV','ii','V','I','VI'],tags:['gospel','cycle','tonicization'],
    classic:.18,bebop:.12,modern:.62,neosoul:1.15,rnb:2.10,
    first:['IΔ9','iii7','vi9','IVΔ9','ii9','V13','iii7,VI7','ii9,V13'],
    second:['IΔ9','V7/vi','vi9','IVΔ9','ii9','V13','IΔ9','VI7'],
    final:['IΔ9','V7/vi','vi9','IVΔ9','ii9','V13','IΔ9','I6/9'],
  },
  {
    id:'a-biii-side',family:'chromatic bIII side-step',weight:12,minColor:62,centers:['I','bIII','ii','V','I','VI','ii','V'],tags:['chromatic','tonicization','cycle'],
    classic:.2,bebop:1.25,modern:1.42,neosoul:.85,rnb:.55,
...
function styleMultiplier(p:StyleWeights,style:Params['preset']):number{return p[style]??1;}
function weightedPick<T extends StyleWeights&{weight:number;minColor?:number;maxColor?:number;tags?:Tag[]}>(pool:T[],params:Params,salt:number,blockedIds=new Set<string>()):T{
  ...
  const weighted=candidates.map(p=>({p,w:p.weight*styleMultiplier(p,params.preset)*tagMultiplier(p.tags,params.color)}));
...
function formForSeed(params:Params):'AABA'|'ABAC'{
  const chance:Record<Params['preset'],number>={classic:.64,bebop:.56,modern:.58,neosoul:.46,rnb:.52};
  return unit(params.seed,11)<chance[params.preset]?'AABA':'ABAC';
}
...
export function buildStandardChorusPlan(params:Params,chorus:number,previousSummary?:string):ChorusPlan{
  ...
  if(form==='AABA'){
    ...
    append('A2',asASection(aFamily,'second'),'repeat the A grammar with a contrasting second ending');
    ...
    append('B',{bars:[...bridge.bars],centers:[...bridge.centers],phrases:[bridge]},'move through a style-specific contrasting center plan and prepare the return');
    append('A3',asASection(aFamily,'final'),'return to the same A grammar with a resolved final ending');
    return{bars,sections,centers,phrases,summary:`AABA · ${params.preset} · ${aFamily.family} · B ${bridge.family} · resolved A return`};
  }
  ...
  append('B',{bars:[...b.bars],centers:[...b.centers],phrases:[b]},'provide a style-specific contrasting harmonic excursion');
  ...
  append('C',{bars:[...c.bars],centers:[...c.centers],phrases:[c]},'close through one coherent style-specific route');
  return{bars,sections,centers,phrases,summary:`ABAC · ${params.preset} · ${aFamily.family} · B ${b.family} · A return · C ${c.family}`};
}
